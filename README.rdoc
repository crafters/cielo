...
== Buy Page Loja
  ...
  transaction.store_page_create!(transaction_parameters) #inicia uma nova transação
...
== Buy Page Cielo
  ...
  transaction.cielo_page_create!(transaction_parameters) #inicia uma nova transação
...
* Antônio Roberto Silva [ http://github.com/devton , http://twitter.com/devton ]
